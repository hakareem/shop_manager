...
describe Application do
  ...
  it "return a list of all items" do
    ...
    expect(item_repository).to receive(:all).and_return [first, second, third]
    app = Application.new('orders_test', io, item_repository, order_repository)
    app.run
  end
  ...
  it "return a list of all orders" do
    ...
    expect(order_repository).to receive(:all).and_return [first, second, third]
    app = Application.new('orders_test', io, item_repository, order_repository)
    app.run
  end
